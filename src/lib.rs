...
#[derive(Debug)]
pub struct ScamFilterProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ScamFilterProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ScamFilter processing");
    
    let mut processor = ScamFilterProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ScamFilterProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ScamFilterProcessor::new(false);
